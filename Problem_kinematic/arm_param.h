...
#define CARGO_POS_Z 25    // Высота середины схвата для захвата груза
#define ABOVE_CARGO_Z 80   // Высота середины схвата перед опусканием и захватом груза

// Позиция раскрытия самого схвата может меняться от 700 до 350
#define END_EFFECTOR_OPEN 650   // Позиция открытого схвата
#define END_EFFECTOR_CLOSE 460  // Позиция закрытого схава
